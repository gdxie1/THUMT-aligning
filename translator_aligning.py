...
def main(args):
    ...
    model_cls_list = [transformer_cache_fixencoder.Transformer for model in args.models]
    ...
    with tf.Graph().as_default():
        ...
        # Build input queue
        features = dataset.get_inference_input_catch(sorted_inputs, params)
        # Create placeholders
        placeholders = []
